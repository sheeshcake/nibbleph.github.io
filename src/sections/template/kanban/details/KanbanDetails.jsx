...
import { Stack, Drawer, Avatar, Tooltip, Divider, TextField, Box, IconButton, Typography } from '@mui/material';
// components
...
// Redux states
import { updateTasks, deleteTask, saveBoardAsync } from "../../../../redux/slices/kanban";
    ...
    >
      ...
      <Scrollbar>
        <Stack spacing={3} sx={{ px: 2.5, pt: 3, pb: 5 }}>
          ...
          {
            task?.urlLink && <Stack direction="row">
              ...
              >
                ...
                <Link to={task.urlLink} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', color: 'inherit' }}>
                  {task.urlLink}
                </Link>
              </Typography>
            </Stack>
