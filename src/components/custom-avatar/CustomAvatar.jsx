...
const CustomAvatar = forwardRef(({ color, name = '', BadgeProps, children, sx, type = 'default', ...other }, ref) => {
    ...
    colr === 'default' ? (
      ...
      <Avatar
        ...
        sx={{
          ...
          backgroundColor: type === 'profile' ? theme.palette.primary.main : alpha(theme.palette.primary.light, theme.palette.action.selectedOpacity),
