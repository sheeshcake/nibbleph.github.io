...
const WaveAnimation = () => {
  ...
  return (
    <>
      ...
      <div className="absolute bottom-0 left-0 right-0 w-full h-[300px] md:h-[500px] wavelines-wrapper overflow-visible z-10">
        <div
        ...
        >
          <object
            ...
            data="/wavelines.svg"
            type="image/svg+xml"
            className="w-full transform scale-110 md:scale-150 -translate-y-1/4 md:-translate-y-1/3"
          ></object>
