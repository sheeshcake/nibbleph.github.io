...
export default function ContactsPopover() {
  ...
  const assignable_users = useSelector((state) => state.user.virtual_assistants)
  ...
  return (
    <>
      ...
      >
        <Iconify icon="eva:people-fill" sx={{ color: theme.palette.primary.main }}/>
      </IconButtonAnimate>

      <MenuPopover open={openPopover} onClose={handleClosePopover} sx={{ width: 320 }}>
        <Typography variant="h6" sx={{ p: 1.5 }}>
          Contacts <Typography component="span">({assignable_users.length})</Typography>
        </Typography>
