...
function TechnologySvg() {
  return (
    ...
    >
      ...
      <path
        fill="#ffb6b6"
        d="M504.917 490.482l-13.35-21.102 41.903-33.403 17.295-19.16a19.161 19.161 0 0132.418 6.827 19.161 19.161 0 01-11.57 23.991l-27.349 10.075z"
      ></path>
      <path
        fill="#2f2e41"
        d="M191.69 337.48v102.56h71.85V337.48a3.448 3.448 0 00-2.43-3.3 3.175 3.175 0 00-1.03-.16h-64.92a3.463 3.463 0 00-3.47 3.46zm28.04 35.24a7.67 7.67 0 0115.34 0v11.9a7.67 7.67 0 01-15.34 0z"
      ></path>
      <path
        fill="#3f3d56"
        d="M191.47 436.76v9.89a1.946 1.946 0 001.93 1.94h68.43a1.94 1.94 0 001.93-1.94v-9.89zM78.66 182.96v187.26a9.007 9.007 0 009 9h277.5a9.007 9.007 0 009-9V182.96a9.011 9.011 0 00-9-8.99H87.66a9.012 9.012 0 00-9 8.99z"
      ></path>
      <path
        fill="#fff"
        d="M85.17 185.29v182.62a4.818 4.818 0 004.81 4.81h272.87a4.818 4.818 0 004.81-4.81V185.29a4.82 4.82 0 00-4.81-4.82H89.98a4.82 4.82 0 00-4.81 4.82z"
      ></path>
      <path
        fill="#2f2e41"
        d="M135.81 447.92a2.948 2.948 0 002.32 1.11h162.34a2.987 2.987 0 002.92-3.6l-2.52-11.97a2.993 2.993 0 00-1.86-2.17 2.895 2.895 0 00-1.06-.2H140.64a2.894 2.894 0 00-1.06.2 2.992 2.992 0 00-1.86 2.17l-2.52 11.97a2.985 2.985 0 00.61 2.49z"
      ></path>
      <path
        fill="#3f3d56"
        d="M353.994 205.628H98.671a1.016 1.016 0 010-2.031h255.323a1.016 1.016 0 010 2.03z"
      ></path>
      <ellipse
        cx="116.051"
        cy="192.33"
      ...
      <path
        fill="#3f3d56"
        d="M341.616 187.75h-14.6a1.105 1.105 0 000 2.21h14.6a1.105 1.105 0 000-2.21zM341.616 191.9h-14.6a1.105 1.105 0 000 2.21h14.6a1.105 1.105 0 000-2.21zM341.616 196.05h-14.6a1.105 1.105 0 000 2.21h14.6a1.105 1.105 0 000-2.21z"
      ></path>
      <path
        fill="#2f2e41"
        d="M693.596 441.101a6.416 6.416 0 006.183 4.331l26.492-.682a6.329 6.329 0 005.98-4.657l3.75-40.087a9.794 9.794 0 004.237.871 9.661 9.661 0 10-.485-19.317 8.184 8.184 0 00-1.736.181 6.548 6.548 0 00-4.874-2.103l-40.75 1.052a5.853 5.853 0 00-1.006.125 6.365 6.365 0 00-4.873 8.265zm43.173-43.817l2.668-9.552a6.506 6.506 0 00.02-3.375c.13 0 .244-.062.373-.062a6.91 6.91 0 01.324 13.817 6.505 6.505 0 01-3.385-.828z"
      ></path>
      <path
        fill="#3f3d56"
        d="M691.387 380.815c.869 4.964 10.63 8.454 22.366 7.847 10.793-.497 19.618-4.287 21.235-8.778a6.025 6.025 0 00-1.845-.246l-40.75 1.052a5.853 5.853 0 00-1.006.125z"
      ></path>
      <path
        fill="#3d7a8d"
        d="M715.904 419.073a.497.497 0 00.151-.066l5.753-3.766a.5.5 0 000-.836l-5.98-3.917a.5.5 0 10-.547.836l5.34 3.498-5.113 3.348a.5.5 0 00.396.903zM706.818 419.492a.5.5 0 00.126-.918l-5.303-3.04 5.125-3.808a.5.5 0 10-.596-.802l-5.738 4.263a.5.5 0 00.049.834l5.965 3.42a.5.5 0 00.372.051zM715.332 422.373a.482.482 0 00.137-.058.5.5 0 00.168-.687l-8.156-13.408a.5.5 0 00-.854.52l8.155 13.409a.5.5 0 00.55.224z"
      ></path>
      <rect
        width="50.719"
        height="10.846"
